...
const faqs = [
  {
    question: "Is this BMP to WEBP converter free?",
    answer:
      "Yes. You can upload BMP images, convert them to WEBP, and download the results here for free.",
  },
  {
...
export function BmpToWebpExplainer() {
  return (
