...
const faqs = [
  {
    question: "Is this GIF to WEBP converter free?",
    answer:
      "Yes. You can upload GIF images, convert them to WEBP, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. This converter uses the first frame of each GIF and creates a still WEBP file.",
  },
  {
...
export function GifToWebpExplainer() {
  return (
