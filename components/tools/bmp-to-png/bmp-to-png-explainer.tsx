...
const faqs = [
  {
    question: "Is this BMP to PNG converter free?",
    answer:
      "Yes. You can upload BMP images, convert them to PNG, and download the results here for free.",
  },
  {
...
export function BmpToPngExplainer() {
  return (
