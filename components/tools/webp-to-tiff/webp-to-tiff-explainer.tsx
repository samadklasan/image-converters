...
const faqs = [
  {
    question: "Is this WEBP to TIFF converter free?",
    answer:
      "Yes. You can upload WEBP images, convert them to TIFF, and download the results here for free.",
  },
  {
...
export function WebpToTiffExplainer() {
  return (
