...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload WEBP images, convert them to AVIF, and download the results here for free.",
  },
  {
...
export function WebpToAvifExplainer() {
  return (
