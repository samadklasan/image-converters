...
const faqs = [
  {
    question: "Is this BMP to AVIF converter free?",
    answer:
      "Yes. You can upload BMP images, convert them to AVIF, and download the results here for free.",
  },
  {
...
export function BmpToAvifExplainer() {
  return (
