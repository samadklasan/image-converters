import { GifToJpgConverter } from "@/components/tools/gif-to-jpg/gif-to-jpg-converter";
import { GifToJpgExplainer } from "@/components/tools/gif-to-jpg/gif-to-jpg-explainer";
import { sniglet } from "@/lib/fonts";

export function GifToJpgPage() {
  return (
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="max-w-3xl">
                      ...
                      <p className="mt-3 max-w-2xl font-body text-[15px] leading-[1.5] text-white sm:text-[16px]">
                        Convert GIF images to JPG for fast sharing, smaller uploads, and broad compatibility.
                      </p>
                    </div>
                  </div>
                </div>
