...
const faqs = [
  {
    question: "Is this AVIF to BMP converter free?",
    answer:
      "Yes. You can upload AVIF images, convert them to BMP, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in AVIF to BMP?",
    answer:
      "BMP files are usually much larger than modern formats because they do not use web-style compression.",
  },
  {
    question: "Why are AVIF to BMP files often larger?",
    answer:
...
export function AvifToBmpExplainer() {
  return (
