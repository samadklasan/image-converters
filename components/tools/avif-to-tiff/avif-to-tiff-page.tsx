import { AvifToTiffConverter } from "@/components/tools/avif-to-tiff/avif-to-tiff-converter";
import { AvifToTiffExplainer } from "@/components/tools/avif-to-tiff/avif-to-tiff-explainer";
import { sniglet } from "@/lib/fonts";

export function AvifToTiffPage() {
  return (
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="max-w-3xl">
                      ...
                      <p className="mt-3 max-w-2xl font-body text-[15px] leading-[1.5] text-white sm:text-[16px]">
                        Convert AVIF images to TIFF for print-friendly output and high-detail workflows.
                      </p>
                    </div>
                  </div>
                </div>
