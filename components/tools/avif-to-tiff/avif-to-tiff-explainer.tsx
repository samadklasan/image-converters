...
const faqs = [
  {
    question: "Is this AVIF to TIFF converter free?",
    answer:
      "Yes. You can upload AVIF images, convert them to TIFF, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in AVIF to TIFF?",
    answer:
...
export function AvifToTiffExplainer() {
  return (
