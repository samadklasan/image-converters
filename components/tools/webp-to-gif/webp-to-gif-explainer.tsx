...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload WEBP images, convert them to GIF, and download the results here for free.",
  },
  {
...
export function WebpToGifExplainer() {
  return (
