...
const faqs = [
  {
    question: "Is this BMP to JPG converter free?",
    answer:
      "Yes. You can upload BMP images, convert them to JPG, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in BMP to JPG?",
    answer:
      "JPG is a lossy format, so it trades some image data for smaller files that are easier to share.",
  },
  {
    question: "What happens to transparency in BMP to JPG?",
    answer:
...
export function BmpToJpgExplainer() {
  return (
