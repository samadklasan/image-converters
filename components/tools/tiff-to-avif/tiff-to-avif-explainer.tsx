const usageSteps = [
  ...
  },
  {
    ...
    description:
      "Click Convert to AVIF and let the tool prepare each output file in sequence.",
  },
  {
    title: "Download finished AVIF files",
    description:
...
const faqs = [
  {
    question: "Is this TIFF to AVIF converter free?",
    answer:
      "Yes. You can upload TIFF images, convert them to AVIF, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Choose AVIF when you want a modern image format focused on smaller files and efficient web delivery.",
  },
  {
    question: "How does image quality change in TIFF to AVIF?",
    answer:
      "AVIF is built for strong compression, so it can shrink file size while still looking sharp in supported workflows.",
  },
  {
    question: "Can TIFF to AVIF keep transparency?",
    answer:
      "Yes. AVIF can preserve transparency when the uploaded image includes it.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted AVIF output.",
  },
  {
    question: "Can I download files before the whole batch finishes?",
    answer:
      "Yes. Each AVIF file can be saved as soon as that individual conversion is ready.",
  },
] as const;
...
export function TiffToAvifExplainer() {
  return (
