const usageSteps = [
  ...
  },
  {
    ...
    description:
      "Click Convert to GIF and let the tool prepare each output file in sequence.",
  },
  {
    title: "Download finished GIF files",
    description:
...
const faqs = [
  {
    question: "Is this TIFF to GIF converter free?",
    answer:
      "Yes. You can upload TIFF images, convert them to GIF, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Choose GIF when you need a simple still-image export for an older slot, lightweight share, or basic compatibility case.",
  },
  {
    question: "How does image quality change in TIFF to GIF?",
    answer:
      "GIF is limited to 256 colors, so gradients and photo detail may look simpler than the original image.",
  },
  {
    question: "Will TIFF to GIF create animation?",
    answer:
      "No. This converter creates a single still GIF from each uploaded image.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted GIF output.",
  },
  {
    question: "Can I download files before the whole batch finishes?",
    answer:
      "Yes. Each GIF file can be saved as soon as that individual conversion is ready.",
  },
] as const;
...
export function TiffToGifExplainer() {
  return (
