type JpgToBmpToolCardIconProps = {
  disableGroupHover?: boolean;
};

export function JpgToBmpToolCardIcon({
  disableGroupHover = false,
}: JpgToBmpToolCardIconProps) {
  return (
    <div
...
<path d="M325 105H250a5 5 0 0 1-5-5V25a5 5 0 1 1 10 0V95h70a5 5 0 0 1 0 10Z" />
        ...
        <path d="M238.61 236H229V182.68h21.84q9.34 0 13.85 4.71a16.37 16.37 0 0 1-.37 22.95 17.49 17.49 0 0 1-12.38 4.53H238.61Zm0-29.37H250q4.45 0 6.8-2.19a7.58 7.58 0 0 0 2.34-5.82A8 8 0 0 0 257 193q-2.17-2.34-7.83-2.34H238.61Z" />
      </svg>
    </div>
  );
}
