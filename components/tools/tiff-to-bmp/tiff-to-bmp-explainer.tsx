const usageSteps = [
  {
    ...
    description:
      "Add one TIFF image or a batch from your device. Multi-page TIFF uploads are converted from their first page.",
  },
  {
    title: "Convert to BMP",
    description:
      "Click Convert to BMP and let the tool prepare each output file in sequence.",
  },
  {
    title: "Download finished BMP files",
    description:
...
const faqs = [
  {
    question: "Is this TIFF to BMP converter free?",
    answer:
      "Yes. You can upload TIFF images, convert them to BMP, and download the results here for free.",
  },
  {
    question: "What files can I upload here?",
    answer:
      "This converter accepts TIFF image files only.",
  },
  {
    question: "Why convert TIFF to BMP?",
    answer:
      "Use BMP when you need a basic bitmap file for a legacy tool, technical import, or niche workflow that expects BMP.",
  },
  {
    question: "How does image quality change in TIFF to BMP?",
    answer:
      "BMP files are usually much larger than modern formats because they do not use web-style compression.",
  },
  {
    question: "Why are TIFF to BMP files often larger?",
    answer:
      "BMP is a simple bitmap format, so the converted file is often much larger than compressed formats like AVIF, WEBP, or JPG.",
  },
  {
    question: "Can I convert a batch of TIFF images?",
    answer:
      "Yes. You can convert up to 20 TIFF files in one batch, then save the finished results individually or all together.",
  },
  {
  ...
  {
    question: "Which TIFF page is converted?",
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted BMP output.",
  },
  {
    question: "Can I download files before the whole batch finishes?",
    answer:
      "Yes. Each BMP file can be saved as soon as that individual conversion is ready.",
  },
] as const;
...
export function TiffToBmpExplainer() {
  return (
