const usageSteps = [
  {
    ...
    "description": "Add one JPG or a full batch of JPG photos, screenshots, or exported graphics from your device."
  },
  {
    "title": "Convert them to PNG",
    "description": "Start the conversion and the tool will rebuild each file as a PNG one by one."
  },
  {
    "title": "Download each finished PNG",
    "description": "Save files individually as they finish, or export the whole completed batch at once."
  }
] as const;
...
const faqs = [
  {
    ...
    "answer": "Yes. You can upload JPG images, convert them to PNG, and download the results here for free."
  },
  {
  ...
  },
  {
    ...
    "answer": "PNG is useful when you want a lossless file for further editing, repeated exports, or design handoff work."
  },
  {
    "question": "Will converting JPG to PNG improve the original photo quality?",
    "answer": "No. PNG can prevent new quality loss after conversion, but it cannot restore detail already lost in the original JPG compression."
  },
  {
    "question": "Can JPG to PNG create transparent backgrounds?",
    "answer": "No. If the original JPG already has a solid background, converting it to PNG will not magically recreate transparency."
  },
  {
    "question": "Will PNG files usually be larger than JPG files?",
    "answer": "Often yes. PNG usually trades smaller photo compression for cleaner, lossless image data."
  },
  {
    "question": "Can I convert a batch of JPG files together?",
    "answer": "Yes. You can convert up to 20 JPG images in one batch and download files as they finish."
  },
  {
...
export function JpgToPngExplainer() {
  return (
