...
const faqs = [
  {
    question: "Is this TIFF to PNG converter free?",
    answer:
      "Yes. You can upload TIFF images, convert them to PNG, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in TIFF to PNG?",
    answer:
  ...
  },
  {
    ...
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted PNG output.",
  },
  {
...
export function TiffToPngExplainer() {
  return (
