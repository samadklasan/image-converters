import { GifToBmpConverter } from "@/components/tools/gif-to-bmp/gif-to-bmp-converter";
import { GifToBmpExplainer } from "@/components/tools/gif-to-bmp/gif-to-bmp-explainer";

export function GifToBmpPage() {
  return (
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="max-w-3xl">
                      ...
                      <p className="mt-3 max-w-2xl font-body text-[15px] leading-[1.5] text-white sm:text-[16px]">
                        Convert GIF images to BMP for simple bitmap exports and legacy software workflows.
                      </p>
                    </div>
                  </div>
                </div>
