...
const faqs = [
  {
    question: "Is this GIF to BMP converter free?",
    answer:
      "Yes. You can upload GIF images, convert them to BMP, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. This converter uses the first frame of each GIF and creates a still BMP file.",
  },
  {
...
export function GifToBmpExplainer() {
  return (
