...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload TIFF images, convert them to JPG, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in TIFF to JPG?",
    answer:
      "JPG is a lossy format, so it trades some image data for smaller files that are easier to share.",
  },
  {
    question: "What happens to transparency in TIFF to JPG?",
    answer:
  ...
  },
  {
    ...
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted JPG output.",
  },
  {
...
export function TiffToJpgExplainer() {
  return (
