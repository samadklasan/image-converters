...
const faqs = [
  {
    question: "Is this GIF to PNG converter free?",
    answer:
      "Yes. You can upload GIF images, convert them to PNG, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. This converter uses the first frame of each GIF and creates a still PNG file.",
  },
  {
...
export function GifToPngExplainer() {
  return (
