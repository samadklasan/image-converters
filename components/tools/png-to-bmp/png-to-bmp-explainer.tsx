const usageSteps = [
  ...
  },
  {
    ...
    description:
      "Click Convert to BMP and let the tool process each image.",
  },
  {
    title: "Download finished BMPs",
    description:
...
const faqs = [
  ...
  {
    question: "Why would I convert PNG to BMP?",
    answer:
      "BMP can help when you need an image for older software or a workflow that expects BMP files.",
  },
  {
    question: "What happens to transparent PNG backgrounds in BMP?",
    answer:
      "BMP does not keep PNG transparency the same way, so transparent areas may turn solid.",
  },
  {
    question: "Why is my BMP file larger than the original PNG?",
    answer:
      "BMP files often end up larger because PNG uses stronger compression, while BMP keeps image data in a simpler bitmap structure.",
  },
  {
    question: "What happens after I click Convert to BMP?",
    answer:
  ...
  {
    question: "Do you store my PNG or BMP files?",
    answer:
      "No. Your files stay in your browser while the conversion runs.",
  },
  {
    question: "When should I keep PNG instead of converting to BMP?",
    answer:
      "Keep PNG when you want smaller files or need to keep transparency.",
  },
  {
    question: "Can I download BMP files before the whole batch finishes?",
    answer:
...
export function PngToBmpExplainer() {
  return (
