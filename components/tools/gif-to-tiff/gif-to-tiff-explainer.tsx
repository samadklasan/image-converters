...
const faqs = [
  {
    question: "Is this GIF to TIFF converter free?",
    answer:
      "Yes. You can upload GIF images, convert them to TIFF, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in GIF to TIFF?",
    answer:
  ...
  },
  {
    ...
    answer:
      "No. This converter uses the first frame of each GIF and creates a still TIFF file.",
  },
  {
...
export function GifToTiffExplainer() {
  return (
