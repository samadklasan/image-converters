const usageSteps = [
  ...
  },
  {
    ...
    description:
      "Click Convert to TIFF and let the tool process each image.",
  },
  {
    title: "Download finished TIFFs",
    description:
...
const faqs = [
  ...
  {
    question: "Why would I convert PNG to TIFF?",
    answer:
      "TIFF is often used for print, editing, and other quality-focused workflows.",
  },
  {
    question: "Does TIFF keep transparency from PNG files?",
    answer:
      "Yes, in many cases TIFF can keep transparent backgrounds.",
  },
  {
    question: "Will TIFF files usually be larger than PNG files?",
    answer:
      "Yes, often. TIFF files are usually larger than PNG files.",
  },
  {
    question: "What happens after I click Convert to TIFF?",
    answer:
  ...
  {
    question: "Do you store my PNG or TIFF files?",
    answer:
      "No. Your files stay in your browser while the conversion runs.",
  },
  {
    question: "When should I convert PNG to TIFF?",
    answer:
      "Convert to TIFF when you need a format for print or desktop editing tools.",
  },
  {
    question: "When should I keep PNG instead of converting to TIFF?",
    answer:
      "Keep PNG when you want smaller files or an image that is easier to use on the web.",
  },
  {
    question: "Can I download TIFF files before the whole batch finishes?",
    answer:
...
export function PngToTiffExplainer() {
  return (
