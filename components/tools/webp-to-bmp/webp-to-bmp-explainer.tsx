const usageSteps = [
  {
    ...
    description:
      "Add one WEBP image or a full batch from your device to start the conversion.",
  },
  {
...
const faqs = [
  {
    question: "Is this WEBP to BMP converter free?",
    answer:
      "Yes. You can upload WEBP images, convert them to BMP, and download the results here for free.",
  },
  {
    question: "What files can I upload here?",
    answer:
      "This converter accepts WEBP image files only.",
  },
  {
  ...
  {
    question: "How does image quality change in WEBP to BMP?",
    answer:
      "BMP files are usually much larger than modern formats because they do not use web-style compression.",
  },
  {
    question: "Why are WEBP to BMP files often larger?",
    answer:
      "BMP is a simple bitmap format, so the converted file is often much larger than compressed formats like AVIF, WEBP, or JPG.",
  },
  {
    question: "Can I convert a batch of WEBP images?",
    answer:
      "Yes. You can convert up to 20 WEBP files in one batch, then save the finished results individually or all together.",
  },
  {
  ...
  {
    question: "Why convert WEBP files at all?",
    answer:
      "WEBP works well online, but converting can help when a project, editor, or workflow expects another image format.",
  },
  {
...
export function WebpToBmpExplainer() {
  return (
