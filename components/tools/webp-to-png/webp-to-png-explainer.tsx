...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload WEBP images, convert them to PNG, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in WEBP to PNG?",
    answer:
...
export function WebpToPngExplainer() {
  return (
