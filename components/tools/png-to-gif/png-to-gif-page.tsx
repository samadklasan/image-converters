...
import { PngToGifConverter } from "@/components/tools/png-to-gif/png-to-gif-converter";
import { PngToGifExplainer } from "@/components/tools/png-to-gif/png-to-gif-explainer";
import { sniglet } from "@/lib/fonts";

export function PngToGifPage() {
  return (
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="max-w-3xl">
                      ...
                      <p className="mt-3 max-w-2xl font-body text-[15px] leading-[1.5] text-white sm:text-[16px]">
                        Turn PNG images into GIF files for simple graphics, older platforms, and lightweight visual sharing.
                      </p>
                    </div>
                  </div>
                </div>
