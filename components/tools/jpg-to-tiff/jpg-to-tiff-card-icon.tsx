type JpgToTiffToolCardIconProps = {
  disableGroupHover?: boolean;
};

export function JpgToTiffToolCardIcon({
  disableGroupHover = false,
}: JpgToTiffToolCardIconProps) {
  return (
    <div
...
<path d="M325 105H250a5 5 0 0 1-5-5V25a5 5 0 0 1 10 0V95h70a5 5 0 1 1 0 10Z" />
        ...
        <g transform="translate(9 0)">
          <path d="M128 182.68H164V190.41H150.8V236h-9.61V190.41H128Z" />
          <path d="M181 236h-9.61V182.68H181Z" />
          <path d="M218.5 182.68H190.81V236h9.61V211.76h15.46V204.03H200.42V190.41H218.5Z" />
          <path d="M254.5 182.68H226.81V236h9.61V211.76h15.46V204.03H236.42V190.41H254.5Z" />
        </g>
      </svg>
    </div>
  );
