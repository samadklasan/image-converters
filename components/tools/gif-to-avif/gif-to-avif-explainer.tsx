...
const faqs = [
  {
    question: "Is this GIF to AVIF converter free?",
    answer:
      "Yes. You can upload GIF images, convert them to AVIF, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. This converter uses the first frame of each GIF and creates a still AVIF file.",
  },
  {
...
export function GifToAvifExplainer() {
  return (
