...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload AVIF images, convert them to WEBP, and download the results here for free.",
  },
  {
...
export function AvifToWebpExplainer() {
  return (
