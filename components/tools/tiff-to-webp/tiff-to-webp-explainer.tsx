const usageSteps = [
  ...
  },
  {
    ...
    description:
      "Click Convert to WEBP and let the tool prepare each output file in sequence.",
  },
  {
    title: "Download finished WEBP files",
    description:
...
const faqs = [
  {
    question: "Is this TIFF to WEBP converter free?",
    answer:
      "Yes. You can upload TIFF images, convert them to WEBP, and download the results here for free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Pick WEBP when you want a modern image format that stays practical for websites, product pages, and content publishing.",
  },
  {
    question: "How does image quality change in TIFF to WEBP?",
    answer:
      "WEBP is designed to keep file sizes low while still looking good in modern browsers and web workflows.",
  },
  {
    question: "Can TIFF to WEBP keep transparency?",
    answer:
      "Yes. WEBP can preserve transparency when the uploaded image includes it.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "If a TIFF has multiple pages, the first page is used for the converted WEBP output.",
  },
  {
    question: "Can I download files before the whole batch finishes?",
    answer:
      "Yes. Each WEBP file can be saved as soon as that individual conversion is ready.",
  },
] as const;
...
export function TiffToWebpExplainer() {
  return (
