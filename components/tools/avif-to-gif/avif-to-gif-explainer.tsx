...
const faqs = [
  {
    question: "Is this AVIF to GIF converter free?",
    answer:
      "Yes. You can upload AVIF images, convert them to GIF, and download the results here for free.",
  },
  {
...
export function AvifToGifExplainer() {
  return (
