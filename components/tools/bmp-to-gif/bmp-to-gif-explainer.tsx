...
const faqs = [
  {
    question: "Is this BMP to GIF converter free?",
    answer:
      "Yes. You can upload BMP images, convert them to GIF, and download the results here for free.",
  },
  {
...
export function BmpToGifExplainer() {
  return (
