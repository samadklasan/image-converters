...
const faqs = [
  {
    ...
    answer:
      "Yes. You can upload AVIF images, convert them to JPG, and download the results here for free.",
  },
  {
  ...
  {
    question: "How does image quality change in AVIF to JPG?",
    answer:
      "JPG is a lossy format, so it trades some image data for smaller files that are easier to share.",
  },
  {
    question: "What happens to transparency in AVIF to JPG?",
    answer:
...
export function AvifToJpgExplainer() {
  return (
